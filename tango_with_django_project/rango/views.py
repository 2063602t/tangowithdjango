...
def register(request):
    ...
    if request.method == 'POST':
        ...
        # Note that we make use of bothe UserForm and UserProfileForm.
...
def user_login(request):
    ...
    # If the request method is an HTTP POST, try to pull out the relevant information.
    if (request.method) == 'POST':
    ...
    # This scenario would most likely be a HTTP GET.
        ...
        return render(request, 'rango/login.html', dict())


# Use the login required decorator to ensure only those logged in can access this view
@login_required
